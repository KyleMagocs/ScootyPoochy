...
class Gnome(LevelObject):
    ...
    sheet_path = 'objects/backyard/gnome_sheet.png'
...
class BirdBath(LevelObject):
    ...
    sheet_path = 'objects/backyard/birdbath_sheet.png'
...
class Flower1(LevelObject):
    ...
    sheet_path = 'objects/backyard/flower1.png'
...
class Flower2(LevelObject):
    ...
    sheet_path = 'objects/backyard/flower2.png'
...
class Flower3(LevelObject):
    ...
    sheet_path = 'objects/backyard/flower3.png'
...
class Flower4(LevelObject):
    ...
    sheet_path = 'objects/backyard/flower4.png'
...
class Grill(LevelObject):
    ...
    sheet_path = 'objects/backyard/grill.png'
