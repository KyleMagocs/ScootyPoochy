...
class CharacterSelectCharacter(pygame.sprite.Sprite):
    ...
    def update(self):
        ...
        self.x = math.cos(self.angle * radians_factor) * 365 + self.offset_x - (self.current_sprite.get_width() / 2)
        self.y = math.sin(self.angle * radians_factor) * 365 + self.offset_y - (self.current_sprite.get_height() / 2)
